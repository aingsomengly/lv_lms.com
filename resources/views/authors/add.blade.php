        ...
        <div class="x_content">
            <form action="{{ route('authors.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-7 col-xs-12">
                        ...
                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12 xdisplay_inputx form-group has-feedback" >
                                <input type="text" name="dateofbirth" class="form-control" aria-describedby="inputSuccess2Status2" required>
                            </div>
                        </div>
                    ...
                    <a href="{{route('authors.index')}}" type="button" class="btn btn-danger" data-dismiss="modal">Close</a>
            </form>
        </div>
    </div>
