...
@endif
    <div class="x_panel">
        ...
        <div class="x_content">
            <form action="{{ route('requestedbooks.store') }}" method="post" class="form-horizontal form-label-right">
                @csrf
                <div class="row">
                    <div class="col-md-12 col-sm-7 col-xs-12">
                        ...
                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12" >
                                <input type="text" name="action_date" class="form-control" aria-describedby="inputSuccess2Status2" required>
                            </div>
                        </div>
