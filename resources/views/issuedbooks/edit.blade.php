...
@endif
    <div class="x_panel">
        ...
        <div class="x_content">
            <form action="{{ route('issuedbooks.update', $issuedbook->id) }}" method="post" class="form-horizontal form-label-right">
                {{ csrf_field() }}
                {{ method_field('PUT')}}
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12">
                                <input type="text" value="{{$issuedbook->issued_date}}" name="issued_date" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12" >
                                <input type="text" value="{{$issuedbook->expiry_date}}" name="expiry_date" class="form-control" aria-describedby="inputSuccess2Status2" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-8 col-sm-12 col-xs-12 xdisplay_inputx form-group has-feedback" >
                                <input type="text" value="{{$issuedbook->return_date}}" name="return_date" class="form-control" aria-describedby="inputSuccess2Status2" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12 xdisplay_inputx form-group has-feedback" >
                                <input type="text" value="{{$issuedbook->penalty_money}}" name="penalty_money" class="form-control" aria-describedby="inputSuccess2Status2" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-10 col-sm-12 col-xs-12">
                                <input type="text" value="{{$issuedbook->status}}" name="status" class="form-control" required>
                            </div>
                        </div>
