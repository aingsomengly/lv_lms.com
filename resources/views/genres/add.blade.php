...
@endif
    <div class="x_panel">
        ...
        <div class="x_content">
            <form action="{{ route('genres.store') }}" method="post" class="form-horizontal form-label-right">
                @csrf
                <div class="row">
                    ...
                    <a href="{{route('genres.index')}}" type="button" class="btn btn-secondary" data-dismiss="modal">Close</a>
            </form>
        </div>
    </div>
